...
export default function AdminError({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      <div className="admin-panel mx-auto max-w-md overflow-hidden">
        <div className="p-6 text-center sm:p-8">
          ...
          <h1 className="text-foreground mt-5 text-xl font-bold tracking-tight sm:text-2xl">
            Failed to load administrative overview
          </h1>
          <p className="text-muted-foreground mt-2 text-sm leading-6">
            An error occurred while loading administrative data. Please try
            again.
          </p>
